...
export default function header() {
    ...
    return (
        <header className={`w-full h-14 ${isMenuHidden? 'sm:w-16 md:w-20' : ''} sm:h-screen fixed z-1 bg-lemon-chiffon-light`}>
            <div className="p-2 sm:p-4 relative flex items-center justify-between sm:flex-col sm:place-content-between sm:items-center sm:w-16 sm:h-screen"> 
                ...
                <h4 className="hidden sm:block sm:-rotate-90 sm:w-44 sm:font-shalimar sm:text-26 md:text-32">Sarika Mangalpally</h4>
