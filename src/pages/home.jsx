            ...
            <div className="pt-20 md:py-12 lg:py-0 sm:flex">
                <div className="md:w-1/2 relative ml-5 xs:ml-7 md:ml-20 sm:my-auto xl:mt-54">
                    ...
                    <div className="space-x-2 cursor-pointer">
                        <Link to='/Portfolio/hire-me' className="inline-block bg-olive-light text-white py-2 px-4 rounded-lg  hover:transform hover:-translate-y-0.5 drop-shadow-lg shadow-lime-90 active:scale-75 active:ease-in active:duration-300">Hire Me</Link>
                        <Link to="/Portfolio/my-work" className="inline-block underline drop-shadow-lg shadow-lime-900 py-2 px-4 rounded-lg hover:transform hover:-translate-y-0.5 bg-olive-light bg-opacity-5 active:scale-75 active:ease-in active:duration-300">Portfolio</Link>
                    </div>
                </div>
